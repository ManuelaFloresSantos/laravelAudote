...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" method="POST" action="{{ route('anunciados') }}" enctype="multipart/form-data">
                @csrf 
				...
				<div class="wrap-input1">
					<input class="input1" type="text" name="nome" placeholder="Nome do pet">
					<span class="shadow-input1"></span>
				</div>
				<div class="wrap-input1"> 
					<p> <strong> É cachorro ou gatinho? </strong> </p> <br>
				<input id="tipo" type="radio" name="tipo" value="gato"> <strong> Gatinho </strong> <br>
                <input id="tipo" type="radio" name="tipo" value="cachorro"><strong> Cachorrito </strong> <br>
			</div>
			<br>
			<div class="wrap-input1">
			<p> <strong> Selecione o porte do seu pet: </strong> </p> <br>
                <input id="porte" type="radio" name="porte" value="pequeno"> <strong> Pequeno </strong> <br>
                <input id="porte" type="radio" name="porte" value="medio">  <strong> Médio </strong> <br>
                <input id="porte" type="radio" name="porte" value="grande">  <strong> Grande </strong> <br>
			</div>

				<div class="wrap-input1">
					<input class="input1" type="text" name="idade" placeholder="Idade do pet (apenas números)">
					<span class="shadow-input1"></span>
				</div>
				...
				<div class="wrap-input1">
					<input class="input1" type="text" name="descricao" placeholder="Descreva seu pet! (Mais que 10 caracteres)">
					<span class="shadow-input1"></span>
				</div>
